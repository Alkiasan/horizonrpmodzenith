package net.mcreator.horizonrpmod;
...
@Mod("horizonrpmod")
public class HorizonrpmodMod {
	public static final Logger LOGGER = LogManager.getLogger(HorizonrpmodMod.class);
	public static final String MODID = "horizonrpmod";

	public HorizonrpmodMod() {
		...
		HorizonrpmodModMobEffects.REGISTRY.register(bus);
